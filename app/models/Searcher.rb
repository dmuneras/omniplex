...
class Searcher
  ...
  def self.cities
    return self.cities_cinecol
  end

  def self.multiplex city
    return self.multiplex_cinecol city
  end

  def self.movies
    return self.movies_cinecol
  end
  ...
  # ------------------------------------------------------------------------#
  #   Methods to find the relevant information inside multiplex websites    #
  # ------------------------------------------------------------------------#  
  
  def self.cities_cinecol
  ...
  def self.multiplex_cinecol city
    if city.nil?
      url = "http://www.cinecolombia.com/Default.aspx"
    else
